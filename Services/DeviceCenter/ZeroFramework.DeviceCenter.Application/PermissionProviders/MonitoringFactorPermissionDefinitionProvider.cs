...
{
    public class MonitoringFactorPermissionDefinitionProvider : IPermissionDefinitionProvider
    {
        private readonly IStringLocalizer _localizer;

        public MonitoringFactorPermissionDefinitionProvider(IStringLocalizerFactory factory)
        {
