export default {
  ...
  'pages.welcome.identityserver': 'Identity Server',
  ...
  'pages.welcome.alertMessage': 'The Water Party cloud platform is officially launched. It is a water quality and environmental monitoring solution that supports multiple protocols to easily access the cloud platform. Welcome to use it.',
  'pages.welcome.openapi':'Open API',
